    ...
    public class FirstSteps : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    Scale = new float3(1.5 * (i + 1), 1.5 * (i + 1), 1.5 * (i + 1)),
                    Translation = new float3(20 * (i/2 - 1/2), 0, 0)
                };
        ...
        public override void RenderAFrame()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                _cubes[i].GetTransform().Translation = new float3(20 * (i/2 - 1/2), (5 + 5 * i) * Abs(M.Sin((2 * TimeSinceStart) + (M.Pi / 4))), 0);
