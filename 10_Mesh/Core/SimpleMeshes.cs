...
namespace Fusee.Tutorial.Core
{
    public static class SimpleMeshes 
    {
        ...
        public static MeshComponent CreateCylinder(float radius, float height, int segments)
        {
            ...
            {
                // create iterated mantle segments
